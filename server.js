...
setInterval(() => {
  http.get(`http://system1211.glitch.me/`);
}, 280000);
...
const youtube = new YouTube("AIzaSyA4buuPOgO-qGCIuNqyX5P_T_5SY0E6wD0"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyA4buuPOgO-qGCIuNqyX5P_T_5SY0E6wD0"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("guildCreate", (guild) => {
  ...
  Server Support : https://discord.gg/nCUVtMp
...
> **Protection Commands** :gear:
-antibots on/off | -antihack on/off | -antilink on/off

> **Invite Commands** :envelope:
...
`)
 .setFooter('Developer <@532269812190150657>')
